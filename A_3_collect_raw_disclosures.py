# -*- coding: utf-8 -*-
"""
A_3_collect_raw_disclosures.py  ── [수집 단계] 공시 원자료 5년치 long format 수집
...
날짜(rcept_dt)와 함께 넉넉히 5년치 저장한다. 이후 B_1_aggregate_features.py가
...
- 임원 수집 코드는 이 '수집 단계'에 속하지만, 이번에는 실행하지 않는다.
  (이미 뽑아둔 data/network_executives_all.csv,
