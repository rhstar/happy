"""
match_network.py — 네트워크 위험군 임원과 현재 상장사 임원 매칭
...
실행 위치 무관. 출력: network_analysis/data/network_matches.csv
"""
import pandas as pd
import os
...
# ===== 위험기업 임원 (네트워크용, 2013~) =====
risky = pd.read_csv(
    os.path.join(ROOT, "network_analysis/data/network_executives_all.csv"),
    dtype={'위험종목코드': str})
...
out_path = os.path.join(ROOT, "network_analysis/data/network_matches.csv")
