"""
C_2_collect_execs.py — 네트워크 위험군의 경영진 수집 (관찰 창 제한 없음)
...
출력: data/network_executives_all.csv
"""
import os
import time
import pandas as pd
...
if __name__ == '__main__':
    risky = pd.read_csv(
        os.path.join(ROOT, "data/network_risky_set.csv"),
        dtype={'종목코드': str})
    ...
    out_path = os.path.join(ROOT, "data/network_executives_all.csv")
